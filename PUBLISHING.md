...
1. Выберите лицензию и добавьте файл `LICENSE`. Для максимально простого разрешительного варианта обычно выбирают MIT; Apache-2.0 дополнительно содержит явные патентные условия.
